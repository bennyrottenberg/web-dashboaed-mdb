      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-sm-flex pb-4 mb-4 border-bottom justify-content-between">
